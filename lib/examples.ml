    ...
    (mk_binder
       (bind_var f
          (mk_bind
             ...
             (mk_binder (bind_var f (mk_apply (mk_tvar f) (mk_tint (box 3))))))))
...
let ex6_box =
  mk_reset
    (mk_bind
       (mk_shift
          (mk_binder (bind_var k (mk_apply (mk_tvar k) (mk_tint (box 10))))))
       (mk_binder
          (bind_var x
             (mk_bind
                (mk_shift (mk_binder (bind_var k (mk_return (mk_tvar k)))))
                (mk_binder
                   (bind_var y
                      (mk_sequence
                         ...
                         (mk_return
                            (mk_tpair (mk_tvar x) (mk_tbool (box true)))))))))))
...
let ex9_box = mk_sequence ex7_box (mk_return (mk_tint (box 10)))
...
let ex12_box =
  mk_bind
    (mk_disjunct
       (mk_sequence (mk_ensures mk_ststate) (mk_return (mk_tint (box 10))))
       (mk_return (mk_tint (box 42))))
